...
private:
	...
	bool m_dpad_mode = false; // MineSayme: use d-pad buttons instead of joystick
	...
	// MineSayme: d-pad movement buttons
	std::shared_ptr<IGUIImage> m_dpad_up;
	std::shared_ptr<IGUIImage> m_dpad_down;
	std::shared_ptr<IGUIImage> m_dpad_left;
	std::shared_ptr<IGUIImage> m_dpad_right;
	std::unordered_map<size_t, GameKeyType> m_dpad_active_pointers;
